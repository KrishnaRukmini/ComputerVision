...
faceCascade = cv2.CascadeClassifier('question_9/data/haarcascade_frontalface_default.xml')
smileCascade = cv2.CascadeClassifier('question_9/data/haarcascade_smile.xml')
